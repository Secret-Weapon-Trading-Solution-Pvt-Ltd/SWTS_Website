        ...
        <div className="relative text-center">
          ...
          <div className="relative z-10">
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-black max-w-3xl mx-auto leading-relaxed mb-4"
            >
              Secret Weapon Trading Solution Pvt. Ltd. respects your privacy and is committed to
              protecting your personal information. This policy explains how we collect, use, store,
