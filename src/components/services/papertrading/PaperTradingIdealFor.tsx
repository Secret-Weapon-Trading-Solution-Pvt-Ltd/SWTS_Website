...
import { Rocket, RefreshCw, Target, CheckCircle2 } from 'lucide-react';
import ContactCTA from '@/components/ui/ContactCTA';

const profiles = [
  { icon: Rocket, title: "First-Time Automators", description: "You've built or bought an automated strategy but have never deployed it on live markets before" },
  { icon: RefreshCw, title: "Strategy Updaters", description: "You've modified your existing strategy and want to validate the changes before risking real capital" },
  { icon: Target, title: "Serious Traders", description: "You believe in doing things right—testing thoroughly before committing money to any new system" }
];

export default function PaperTradingIdealFor() {
  return (
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-black max-w-3xl mx-auto leading-relaxed mt-4">
              If you&apos;re about to go live with a strategy, paper trading is the final validation step that separates professionals from gamblers
            </p>
          </div>

          {/* Profiles Grid: 3 columns */}
