...
import { Clock, Moon, TrendingUp, CheckCircle2 } from 'lucide-react';
...
export default function AlertsIdealFor() {
  return (
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <h3 className="text-4xl sm:text-5xl font-bold text-black">
              Who Needs Custom Alerts?
            </h3>
            <p className="text-xl text-black max-w-3xl mx-auto leading-relaxed mt-4">
              If you can&apos;t watch charts 24 hours a day, custom alerts ensure you never miss an opportunity
            </p>
          </div>
