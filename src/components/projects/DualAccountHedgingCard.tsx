...
import { ArrowRight, Activity, BarChart2, RefreshCw, Monitor, Sparkles } from 'lucide-react';
...
export const DualAccountHedgingCard: React.FC = () => {
  const icons = [Activity, BarChart2, RefreshCw, Monitor];
            ...
            <div className="relative grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-3">
                ...
                <p className="text-lg text-black mb-5 leading-relaxed">
                  Built for advanced traders who manage risk through simultaneous long and short hedging strategies across two separate brokerage accounts — with synchronized automated execution and complete real-time visibility into both legs.
                </p>

                <p className="text-lg text-black mb-6 leading-relaxed">
                  <span className="font-semibold text-slate-700">The Challenge: </span>
                  Coordinating hedge trades across two accounts manually introduces synchronization gaps, delayed responses to market moves, and no centralized visibility into live positions or P&L for both legs...
                </p>
...
export default DualAccountHedgingCard;
