...
import { ArrowRight, TrendingUp, BarChart2, Monitor, Zap, Sparkles } from 'lucide-react';

const metrics = [
  { label: 'Assets', value: 'BTC+ETH' },
  { label: 'Strategies', value: 'Bull/Bear' },
  { label: 'Monitoring', value: 'Real-time' },
  { label: 'Mode', value: 'Live/Paper' },
];

export const WealthOrbitsCard: React.FC = () => {
  const icons = [TrendingUp, BarChart2, Monitor, Zap];
            ...
            <div className="relative grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-3">
                ...
                <p className="text-lg text-black mb-5 leading-relaxed">
                  An advanced algorithmic trading platform built for automated crypto options trading — combining real-time strategy execution, quantitative signal analysis, and live portfolio monitoring within a single modern dashboard.
                </p>

                <p className="text-lg text-black mb-6 leading-relaxed">
                  <span className="font-semibold text-slate-700">The Challenge: </span>
                  Crypto options trading requires simultaneous monitoring of multiple assets, rapid signal confirmation across timeframes, and precise execution — tasks too complex and fast-moving for manual management...
                </p>
              ...
              {/* Right: Metrics Grid - 2 on top, 2 on bottom */}
...
export default WealthOrbitsCard;
