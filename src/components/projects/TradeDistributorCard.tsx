...
export const TradeDistributorCard: React.FC = () => {
            ...
            <div className="relative grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-3">
                <div className="flex items-start gap-4 mb-5">
                  ...
                  >
                    <img src="/tds-favicon.png" alt="Trade Distributor Logo" className="w-8 h-8 rounded-lg" />
                  </div>
                  <div className="pt-1">
                ...
                <p className="text-lg text-black mb-5 leading-relaxed">
                  Built for prop trading firms and fund managers who manage multiple brokerage accounts and need synchronized, automated order execution without manual intervention.
                </p>

                <p className="text-lg text-black mb-6 leading-relaxed">
                  <span className="font-semibold text-slate-700">The Challenge: </span>
                  Managing and replicating trades across multiple accounts manually introduces execution delays, synchronization gaps, and no centralized visibility into performance or latency...
                </p>
...
export default TradeDistributorCard;
